...
hidden if the `perceptron_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `perceptron_DEVELOPER_MODE` to the configure
...
Runs the executable target `perceptron_exe`.
